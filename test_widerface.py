...
if __name__ == '__main__':
    ...
    #parser.add_argument('--weights', nargs='+', type=str, default=str(DEFAULT_ROOT / 'runs' / 'train' / 'exp5' / 'weights' / 'last.pt'))
    parser.add_argument('--weights', nargs='+', type=str, default=str(DEFAULT_ROOT / 'yolov5n-face.pt'))
    ...
    parser.add_argument('--project', default=str(DEFAULT_ROOT / 'runs' / 'detect'), help='save results to project/name')
    ...
    #parser.add_argument('--folder_pict', default='C:/python_work/tftrain/workspace/YOLOv5n_FACE/widerface/val/wider_val.txt', type=str, help='folder_pict')
    parser.add_argument('--dataset_folder', default=str(DEFAULT_ROOT / 'data' / 'WiderFace' / 'val' / 'images'), type=str, help='dataset path')
    parser.add_argument('--save_folder', default=str(DEFAULT_ROOT / 'widerface_evaluate' / 'widerface_txt'), type=str, help='Dir to save txt results')
    parser.add_argument('--folder_pict', default=str(DEFAULT_ROOT / 'data' / 'WiderFace' / 'val' / 'wider_val.txt'))
    ...
    with torch.no_grad():
        ...
        image_paths = glob.glob(os.path.join(testset_folder, '**', '*.jpg'), recursive=True)
